...
print(f"*** RESULTADOS ***")
J_0 = radiacion_solar_extraterrestre(dia_juliano, (angulo)*a)
J_Z = radiacion_solar(alpha, (90-angulo)*a, J_0, altura)

print(f"Radiación solar extraterrestre: {J_0:.3f} W/m^2")
print(f"Ángulo de incidencia: {angulo}°")
print(f"Día Juliano: {dia_juliano}")

# Tabla de valores de: Altura (m) vs Radiación Solar Espectral:
